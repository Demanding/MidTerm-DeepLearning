...
class VGG16(object):
	...
	def build(self, rgb, train_mode=None):
        ...
        def train_last_layer_variables(self, train_last_layer_variables):
                ...
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "fc2/weights:0"][0])
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "fc2/biases:0"][0])
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "fc1/weights:0"][0])
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "fc1/biases:0"][0])
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "conv5_1/weights:0"][0])
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "conv5_1/biases:0"][0])
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "conv5_2/weights:0"][0])
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "conv5_2/biases:0"][0])
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "conv5_3/weights:0"][0])
                train_last_layer_variables.append([v for v in tf.global_variables() if v.name == "conv5_3/biases:0"][0])
