...
import random
from DataInput_train_caltech101 import DataInput
from DataInput_test_caltech101 import DataInputTest
from alexnet_caltech101 import VGG16
import os
import time
import pdb
dataset_path = "./"
train_labels_file = "datasets/caltech101-train.txt"
test_labels_file = "datasets/caltech101-test.txt"
epoch = 0
IMAGE_HEIGHT = 224
IMAGE_WIDTH = 224
NUM_CHANNELS = 3
...
def main():
	...
	with tf.Graph().as_default():
		...
		eval_correct = evaluation(vgg16.fc3, labels_placeholder)
		try:
			for i in range(NUM_ITERATIONS):
				...
				if (i) % (9145//BATCH_SIZE) == 0 or (i) == NUM_ITERATIONS:
                                        global epoch 
                                        epoch = epoch + 1
