...
import random
from DataInput_train_caltech256 import DataInput
from DataInput_test_caltech256 import DataInputTest
from alexnet_caltech256 import VGG16
import os
import time
import pdb
dataset_path = "./"
train_labels_file = "datasets/dataset_caltech256_train.txt"
test_labels_file = "datasets/dataset_caltech256_test.txt"
epoch = 0
IMAGE_HEIGHT = 224
IMAGE_WIDTH = 224
NUM_CHANNELS = 3
